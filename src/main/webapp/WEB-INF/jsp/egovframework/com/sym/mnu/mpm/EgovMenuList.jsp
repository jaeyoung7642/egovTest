  ...
  <tr>
   ...
   <td style="vertical-align:top">
		...
		<table class="wTable" >
		  ...
		  <tr>
		    <th><spring:message code="comSymMnuMpm.menuList.menuUrl" /> <span class="pilsu">*</span></th><!-- 메뉴 url -->
		    <td>
		      <input name="menuUrl" type="text" size="30" value=""  maxlength="60" title="<spring:message code="comSymMnuMpm.menuList.menuUrl" />">
		    </td>
		  </tr>
		  <tr>
