...
import com.esoom.cmstest.common.ComDefaultVO;
import com.esoom.cmstest.common.IncludedCompInfoVO;
import com.esoom.cmstest.common.IncludedInfo;
...
@Controller
public class EgovAdminController implements ApplicationContextAware, InitializingBean {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(EgovAdminController.class);
	...
	@RequestMapping("/egovadmin/index.do")
	...
	@RequestMapping("/egovadmin/EgovTop.do")
	public String top() {
	...
	@RequestMapping("/egovadmin/EgovLeft.do")
